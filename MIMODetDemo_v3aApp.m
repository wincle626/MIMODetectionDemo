classdef MIMODetDemo_v3aApp < handle
    %
    % Usage:
    %     app.MIMODetDemo_v3aApp
    ...
    properties (Constant)
        AppPathBase = {'/MIMODetDemo_v3a'};
        AppClass = 'MIMODetDemo_v3aApp';
        Increment = 1;
        Decrement = 0;
        Version = '13a';
    end
    ...
    methods
        ...
        function obj = MIMODetDemo_v3aApp()
        ...
        function startApp(obj)
            ...
            mlock;
            MIMODetDemo_v3aApp.refcount(obj.Increment);
            ...
            existVal = exist(fullfile(pwd,'MIMODetDemo_v3a')); %#ok<EXIST>
            ...
            if (doesShadowExist && ~pathOne.equals(pathTwo))
                % We are trying to execute the wrong MIMODetDemo_v3a
                errordlg(message('MATLAB:apps:runapp:WrongEntryPoint', 'MIMODetDemo_v3a').getString, ...
            ...
            if nargout(@MIMODetDemo_v3a) == 0
                eval('MIMODetDemo_v3a');
            else
                obj.AppHandle = eval('MIMODetDemo_v3a');
            end
